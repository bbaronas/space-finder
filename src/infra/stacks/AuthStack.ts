...
import { CfnIdentityPool, CfnIdentityPoolRoleAttachment, CfnUserPoolGroup, UserPool, UserPoolClient, UserPoolClientIdentityProvider } from 'aws-cdk-lib/aws-cognito';
...
export class AuthStack extends Stack {
    ...
    private createUserPool() {
        ...
        new CfnOutput(this, 'SpaceUserPoolId', { value: this.userPool.userPoolId });
    }
    ...
    private createIdentityPool() {
        ...
        new CfnOutput(this, 'SpaceIdentityPoolId', { value: this.identityPool.ref });
    }
